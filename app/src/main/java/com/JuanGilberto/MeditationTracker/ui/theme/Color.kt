package com.JuanGilberto.MeditationTracker.ui.theme
...
fun getColorForSessionType(type: com.JuanGilberto.MeditationTracker.data.database.SessionType): Color {
    return when(type) {
        com.JuanGilberto.MeditationTracker.data.database.SessionType.MEDITATION -> MeditationColor
        com.JuanGilberto.MeditationTracker.data.database.SessionType.BREATHING -> BreathingColor
        com.JuanGilberto.MeditationTracker.data.database.SessionType.YOGA -> YogaColor
        com.JuanGilberto.MeditationTracker.data.database.SessionType.JOURNALING -> JournalingColor
        com.JuanGilberto.MeditationTracker.data.database.SessionType.GRATITUDE -> GratitudeColor
    }
}
