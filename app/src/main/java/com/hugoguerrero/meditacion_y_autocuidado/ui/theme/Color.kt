package com.hugoguerrero.meditacion_y_autocuidado.ui.theme
...
fun getColorForSessionType(type: com.hugoguerrero.meditacion_y_autocuidado.data.database.SessionType): Color {
    return when(type) {
        com.hugoguerrero.meditacion_y_autocuidado.data.database.SessionType.MEDITATION -> MeditationColor
        com.hugoguerrero.meditacion_y_autocuidado.data.database.SessionType.BREATHING -> BreathingColor
        com.hugoguerrero.meditacion_y_autocuidado.data.database.SessionType.YOGA -> YogaColor
        com.hugoguerrero.meditacion_y_autocuidado.data.database.SessionType.JOURNALING -> JournalingColor
        com.hugoguerrero.meditacion_y_autocuidado.data.database.SessionType.GRATITUDE -> GratitudeColor
    }
}
